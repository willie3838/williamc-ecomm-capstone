...
├── cloudbuild.yaml            # Continuous Integration & Delivery pipeline (shared /builder/home/.cb-venv, E2_HIGHCPU_8, 3600s timeout, .changed_files diff detection, Cloud Deploy canary, Agent Engine sync)
